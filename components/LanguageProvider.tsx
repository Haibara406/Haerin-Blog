...
const translations = {
  en: {
    ...
    'cosmos.subtitle': 'Earth, Saturn, and Neptune rendered as interactive voxel bodies. Drag to rotate them, and move close to disturb the surface field in real time.',
  ...
  zh: {
    ...
    'cosmos.subtitle': '用实时 3D 渲染 Earth、Saturn 和 Neptune。拖动可以旋转，鼠标靠近时会扰动体素表面。',
