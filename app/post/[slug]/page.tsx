...
export default function Post({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 flex flex-col xl:flex-row gap-8 xl:gap-12">
        {/* 主内容区 */}
        <article className="flex-1 max-w-3xl mx-auto xl:mx-0 w-full">
          <BackButton />
          ...
          {/* Article Content */}
          <div
            className="prose prose-sm sm:prose-base animate-slide-up"
